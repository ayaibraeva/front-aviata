      ...
      <div class="options-tariffs">
        ...
        <div class="checkboxes">
          <input
            ...
            id="withBaggage"
            :checked="getOption('withBaggage')"
            @input="showWithBaggage"
          />
        ...
        <div class="checkboxes">
          <input
            ...
            class="checkbox-custom"
            id="directFlight"
            :checked="getOption('directFlight')"
            @input="showDirectFlights"
          />
        ...
        <div class="checkboxes">
          <input
            ...
            class="checkbox-custom"
            id="refundableTicket"
            :checked="getOption('refundableTicket')"
            @input="showRefundableTickets"
          />
      ...
      <div class="options-companies">
        ...
        <div class="checkboxes">
          <input
            ...
            class="checkbox-custom"
            id="all"
            :checked="getOption('selectAllAirlines')"
            @input="showAllAirlines"
          />
          <label for="all" v-text="'Все'" />
        </div>
        <div
          class="checkboxes"
          v-for="(checkbox, index) in getAirlineList"
          :key="index"
        >
          <input
            type="checkbox"
            :id="'airline' + index"
            :checked="getAirlineOption(checkbox.airline_code)"
            @input="showAirline(checkbox.airline_code)"
          />
          <label :for="'airline' + index" v-text="checkbox.airline_name" />
        </div>
      </div>
      <base-button variant="blue" @onBtnClick="resetOptions()"
        >Сбросить все фильтры</base-button
      >
    </div>
    <base-button
      variant="filter"
      v-if="isMobile"
      class="filter-btn"
      @onBtnClick="showFilter = !showFilter"
      >Фильтры</base-button
    >
